...
let superMarket = [{
  ...
  "type": "vegetable",
  "description": "Hazelnut in black ceramic bowl on old wooden background. forest weal th.rustic style.selective focus ",
  "filename": "7.jpg",
  "height": 450,
  "width": 301,
  "price": 27.35,
  ...
  "title": "Honey",
  "type": "bakery",
  "description": "Honey and honey cell on the table",
  "filename": "23.jpg",
  "height": 450,
  "width": 299,
  "price": 17.01,
...
// 1
document.write('1. Find the element with rating >= 3<br>');
let result = JSON.stringify(superMarket.find((item) => item.rating >= 3));
document.write(result);
// 2
document.write("<br><br>2. Find the element with type ‘vegetable’<br>");
result = JSON.stringify(superMarket.find((item) => item.type === 'vegetable'));
document.write(result);
// 3
document.write("<br><br>3. Find the element with price < 15<br>");
result = JSON.stringify(superMarket.find((item) => item.price <= 15));
document.write(result);
// 4
document.write("<br><br>4. Find the element with title which contains the word ‘Lemon’<br>");
result = JSON.stringify(superMarket.find((item) => item.title.includes('Lemon')));
document.write(result);
// 5
document.write("<br><br>5. Find the element with height = 450 and width = 450<br>");
result = JSON.stringify(superMarket.find((item) => (item.height === 450 && item.width === 450)));
document.write(result);
...
document.write("<br><br><br>filter() // here only the titles has been shown<br>");
// 1
document.write("1. Filter the elements with rating < 2<br>");
let resultArray = superMarket.filter((item) => item.rating < 2);
resultArray.forEach((item) => document.write(item.title + ", "));

// 2
document.write("<br><br>2. Filter the elements with type ‘dairy’ < 2<br>");
resultArray = superMarket.filter((item) => item.type === 'dairy');
resultArray.forEach((item) => document.write(item.title + ", "));

// 3
document.write("<br><br>3. Filter the elements with price >20 <br>");
resultArray = superMarket.filter((item) => item.price >= 20);
resultArray.forEach((item) => document.write(item.title + ", "));

// 4
document.write("<br><br>4. Filter the elements with title which contains the word ‘with’ <br>");
resultArray = superMarket.filter((item) => item.title.includes('with'));
resultArray.forEach((item) => document.write(item.title + ", "));

// 5
document.write("<br><br>5. Filter the elements with description which contains the word ‘with’ <br>");
resultArray = superMarket.filter((item) => item.description.includes('with'));
resultArray.forEach((item) => document.write(item.title + ", "));

// 6
document.write("<br><br>6. Filter the elements with height = 600 and width = 400 <br>");
resultArray = superMarket.filter((item) => (item.height === 450 && item.width === 450));
resultArray.forEach((item) => document.write(item.title + ", "));

// map()
// 1. Add the property ‘isAvailable: true’ to all the elements
// 1
document.write("<br><br><br>map()")
document.write("<br>1.  Add the property ‘isAvailable: true’ to all the elements<br>");
document.write('this output is in console');
let b = superMarket.map((item) => { return { ...item, 'isAvailable': true } })
console.log('map()#1: ');
console.log(b);
...
document.write("<br><br><br>reduce()");
document.write("<br><br>1. Calculate the averageRatings of all the element <br>");
// 1
const averageRatings = (superMarket.reduce((preVal, curVal, curIndex, superMarket) => {
  return (preVal + curVal.rating)
}, 0)) / superMarket.length;
document.write('averageRatings: '+averageRatings);
document.write("<br><br>2. Calculate the averageHeight of all the element <br>");
// 2
const averageHeight= (superMarket.reduce((preVal, curVal, curIndex, superMarket) => {
  return (preVal + curVal.height)
}, 0)) / superMarket.length;
document.write('averageHeight: '+averageHeight);
document.write("<br><br>3. Calculate the averageWidth of all the element <br>");
// 3
const averageWidth= (superMarket.reduce((preVal, curVal, curIndex, superMarket) => {
  return (preVal + curVal.width)
}, 0)) / superMarket.length;
document.write('averageWidth: '+averageWidth);
document.write("<br><br>4. Calculate the averagePrice of all the element <br>");
// 4
const averagePrice= (superMarket.reduce((preVal, curVal, curIndex, superMarket) => {
  return (preVal + curVal.price)
}, 0)) / superMarket.length;
document.write('averagePrice: '+averagePrice);


// Mix of array methods:
// 1. Filter the elements of type: ‘dairy’ and calculate averageRatings
...
// 4. Filter the elements of type: ‘dairy’ and ‘vegetable’ and add new property ‘isAvailable: true’
// to the filtered elements under type: ‘dairy’ and add new property ‘isAvailable: false’ to the 
// filtered elements under type: ‘vegetable'
document.write("<br><br><br>Mix of array methods");
document.write("<br><br> 1. Filter the elements of type: ‘dairy’ and calculate averageRatings <br>");

 // 1
document.write(superMarket.filter((item) => item.type === 'dairy').reduce((preVal, curVal, superMarket) => {
  return preVal+curVal.rating
},0)/superMarket.filter((item) => item.type==='dairy').length);

document.write("<br><br> 2. Filter the elements of type: ‘vegetable’ and calculate averagePrice <br>");
// 2
document.write((superMarket.filter((item) => item.type === 'vegetable').reduce((preVal, curVal, superMarket) => {
  return preVal+curVal.rating
},0)/superMarket.filter((item) => item.type==='vegetable').length).toFixed(2));
document.write("<br><br> 3. Filter the elements of type: ‘fruit’ and add new property ‘isAvailable: true’ <br>");
// 3
console.log('mix#3: ');
console.log(superMarket.filter((item) => item.type === 'fruit').map((item) => {
  return{
      ...item,
      isAvailable: "True"
  }
...
document.write('answer is in console');
document.write("<br><br> Filter the elements of type: ‘dairy’ and ‘vegetable’ and add new property ‘isAvailable: true’ to the filtered elements under type: ‘dairy’ and add new property ‘isAvailable: false’ to the filtered elements under type: ‘vegetable' <br>");

// 4
console.log('mix#4: ');
console.log(superMarket.filter((item) => item.type === 'fruit' || item.type === 'dairy').map((item) => {
  return{
      ...item,
      isAvailable: "True" 
  }
}).filter((item) => item.type === 'dairy').map((item) => {
  return{
      ...item,
      isAvailable: "False"
  }
